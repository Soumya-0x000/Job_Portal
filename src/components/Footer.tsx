...
import { footerLists } from "../common/DemoData";
            ...
            <div className="px-4 pt-10 pb-6 mx-auto sm:px-6 lg:px-8">
                ...
                <div className="">
                    ...
                    <div className="flex items-center justify-between text-teal-400">
                        ...
                        <form
                            className="flex w-full md:w-[75%] lg:w-[65%] xl:w-[45rem] rounded-lg"
                            onSubmit={handleSubmit}
                        >
                            <div className="relative w-full h-full">
                                <input
                                    type="email"
                                    className={`border-b-2 border-slate-300 pt-2.5 pb-2 pl-2 pr-[6rem] focus:border-b-2 ${
                                        email || isFocused
                                            ? "border-indigo-500"
                                            : ""
                                    } transition-colors focus:outline-none peer bg-slate-800 w-full h-full font-robotoMono placeholder:text-cyan-300`}
                    ...
                    <div className="grid w-full mt-14 xsm:grid-cols-2 md:grid-cols-3 Lmd:grid-cols-5 gap-x-16 gap-y-14 place-content-center">
                        {footerLists.map((list, index: number) => (
                            <div className={`max-w-[10rem]`} key={index}>
                ...
                <div className="pt-8 mt-8 border-t border-gray-100">
                    <div className="flex flex-col items-center justify-center md:flex-row sm:justify-between gap-y-6">
                        <span className="text-[.9rem] sm:text-sm text-gray-300">
                            &copy; 2024. Stumate. All rights reserved.
                        </span>

                        <div className=" flex items-center gap-4 text-xs text-[.9rem] sm:text-sm">
                            <a
                                className="no-underline text-violet-400 hover:text-blue-300 hover:underline"
                                href="#"
                            >
                                Terms & Conditions
                            </a>
